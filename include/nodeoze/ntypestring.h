#ifndef _nodeoze_typestring_h
#define _nodeoze_typestring_h
...
/* 2^0 = 1 */
#define TYPESTRING1(n,x) nodeoze::tygrab<0x##n##0>(x)

/* 2^1 = 2 */
#define TYPESTRING2(n,x) nodeoze::tygrab<0x##n##0>(x), nodeoze::tygrab<0x##n##1>(x) 

/* 2^2 = 2 */
#define TYPESTRING4(n,x) \
        nodeoze::tygrab<0x##n##0>(x), nodeoze::tygrab<0x##n##1>(x) \
      , nodeoze::tygrab<0x##n##2>(x), nodeoze::tygrab<0x##n##3>(x)    

/* 2^3 = 8 */
#define TYPESTRING8(n,x) \
        nodeoze::tygrab<0x##n##0>(x), nodeoze::tygrab<0x##n##1>(x) \
      , nodeoze::tygrab<0x##n##2>(x), nodeoze::tygrab<0x##n##3>(x) \
      , nodeoze::tygrab<0x##n##4>(x), nodeoze::tygrab<0x##n##5>(x) \
      , nodeoze::tygrab<0x##n##6>(x), nodeoze::tygrab<0x##n##7>(x) 
...
#define TYPESTRING16(n,x) \
      ...
      , nodeoze::tygrab<0x##n##4>(x), nodeoze::tygrab<0x##n##5>(x) \
      , nodeoze::tygrab<0x##n##6>(x), nodeoze::tygrab<0x##n##7>(x) \
      , nodeoze::tygrab<0x##n##8>(x), nodeoze::tygrab<0x##n##9>(x) \
      , nodeoze::tygrab<0x##n##A>(x), nodeoze::tygrab<0x##n##B>(x) \
      , nodeoze::tygrab<0x##n##C>(x), nodeoze::tygrab<0x##n##D>(x) \
      , nodeoze::tygrab<0x##n##E>(x), nodeoze::tygrab<0x##n##F>(x)
...
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING1(,x)>()))
#elif USE_TYPESTRING == 1
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING2(,x)>()))
#elif USE_TYPESTRING == 2
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING4(,x)>()))
#elif USE_TYPESTRING == 3
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING8(,x)>()))
#elif USE_TYPESTRING == 4
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING16(,x)>()))
#elif USE_TYPESTRING == 5
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING32(,x)>()))
#elif USE_TYPESTRING == 6
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING64(,x)>()))
#elif USE_TYPESTRING == 7
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING128(,x)>()))
#elif USE_TYPESTRING == 8
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING256(,x)>()))
#elif USE_TYPESTRING == 9
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING512(,x)>()))
#elif USE_TYPESTRING == 10
#define typestring_is(x) \
    decltype(nodeoze::typeek(nodeoze::typestring<TYPESTRING1024(,x)>()))
#elif USE_TYPESTRING > 10
