...
#ifndef NODEOZE_BSTREAM_OBSTREAMBUF_ASSERT_WRITABLE
#define NODEOZE_BSTREAM_OBSTREAMBUF_ASSERT_WRITABLE 1
#endif 

#if ( NODEOZE_BSTREAM_OBSTREAMBUF_ASSERT_WRITABLE )
#define NODEOZE_BSTREAM_OBSTREAMBUF_WRITABLE_ASSERTION { assert( really_make_writable() ); }
#else
#define NODEOZE_BSTREAM_OBSTREAMBUF_WRITABLE_ASSERTION { really_make_writable(); }
#endif
...
protected:
    ...
    make_writable()
    {
        if ( ! writable() )
        {
            NODEOZE_BSTREAM_OBSTREAMBUF_WRITABLE_ASSERTION;
            writable( true );
        }
    }
